...
public class AdminViewCostAnalysisController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    private TableColumn<fcCostAnalysis,Integer> caPackagingCostCol;
    ...
    public void initialize() {
        ...
        caPackagingCostCol.setCellValueFactory(new PropertyValueFactory<>("pkingCost"));
